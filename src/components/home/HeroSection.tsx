...
export const HeroSection = ({ onContactClick }: HeroSectionProps) => {
  ...
  return (
    <HexagonBackground className="relative h-screen min-h-screen max-h-screen w-full overflow-hidden bg-black text-white">
      <section
        ref={heroRef}
        className="relative h-screen min-h-screen max-h-screen overflow-hidden pt-28"
      >
        ...
        <div className="relative z-3 mx-auto flex h-full w-full max-w-7xl items-center px-6 pb-10 md:px-10">
          <div className="relative w-full max-w-4xl">
            <p
              data-animate-hero
              className="mb-5 text-sm font-semibold uppercase tracking-[0.3em] text-yellow-400 md:text-lg"
            >
              Hi!! I Am
            </p>
            ...
            <h1
              data-animate-hero
              className="max-w-4xl text-5xl font-black uppercase leading-[0.95] tracking-tight md:text-7xl lg:text-8xl"
            >
              Gaurav Singh
            </h1>
            <p
              data-animate-hero
              className="mb-5 mt-5 text-xs font-semibold uppercase tracking-[0.3em] text-white md:text-sm"
            >
              And I Am a
            </p>
            ...
            <h1
              data-animate-hero
              className="max-w-4xl text-2xl font-black uppercase leading-[0.95] tracking-tight md:text-4xl lg:text-5xl"
            >
            ...
            <p
              data-animate-hero
              className="mt-6 max-w-xl text-md leading-relaxed text-white/70 md:text-lg"
            >
            ...
            <div data-animate-hero className="mt-8 w-fit">
              <LiquidButton
                type="button"
